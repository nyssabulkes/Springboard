...
/* The above code produces the correct output, but the code below would be
ideal; however, the code below throws an error due to the WHERE clause. I've
tried also replacing 'total_revenue' with SUM(cost), and the same error 
occurs, such that it's deemed an invalid use of the grouping function.
